    ...
    >
      ...
      >
        ...
        <div className="modal-img-wrap">
          ...
          <span className="modal-tag">{service.subtitle}</span>
        </div>
          ...
          <div className="modal-section">
            ...
            <div className="modal-steps">
              {service.steps.map((s, i) => (
                <div key={i} className="modal-step-wrap">
      ...
      <style>{`
        ...
        .modal-backdrop {
          ...
          padding: 20px;
          animation: modal-backdrop-in 0.22s ease;
        }
        .modal-box {
          background: #fff;
          border-radius: 20px;
          ...
          position: relative;
          animation: modal-box-in 0.32s cubic-bezier(0.22,1,0.36,1);
          border-top: 4px solid var(--cc, #2885ef);
        }
        .modal-close {
        ...
        .modal-close:hover { background: rgba(27,42,74,0.14); transform: scale(1.1); }
        ...
        .modal-img-overlay {
          ...
          background: linear-gradient(180deg, transparent 30%, rgba(27,42,74,0.4) 100%);
        }
        .modal-tag {
          position: absolute; bottom: 14px; left: 14px;
          background: var(--cc, #2885ef); color: #fff;
        ...
        .modal-section {
          ...
          border-radius: 12px;
          padding: 0.9rem 1rem;
          border-left: 3px solid var(--cc, #2885ef);
        }
        .modal-label {
        ...
        .modal-cta {
          ...
          box-shadow: 0 8px 22px color-mix(in srgb, var(--cc, #2885ef) 35%, transparent);
          border: none; cursor: pointer;
        }
        .modal-cta:hover {
          filter: brightness(1.1);
          transform: translateY(-2px);
          box-shadow: 0 14px 30px color-mix(in srgb, var(--cc, #2885ef) 45%, transparent);
        }
  ...
  return (
    <section id="services" className="svc-section" ref={sectionRef}>
        ...
        <div className={`svc-grid ${preview ? "grid-preview" : "grid-full"}`}>
          {displayed.map((s, idx) => (
            <article
              ...
              role="button"
              tabIndex={0}
              aria-label={`${s.title} — დეტალების ნახვა`}
              onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); setActiveModal(s); } }}
            >
              {/* Image */}
      ...
      <style>{`
        ...
        .svc-card:focus-visible .card-img { transform: scale(1.09); }
        ...
        .svc-card:focus-visible .card-wash { opacity: 0.16; }
        ...
        .svc-card:focus-visible .card-img-tag {
          opacity: 1;
        ...
        .svc-card:focus-visible .card-title { color: var(--cc); }
        ...
        .svc-card:focus-visible .card-audience {
        ...
        .svc-card:focus-visible .card-cta-row {
          opacity: 1;
          transform: translateY(0);
        }
        ...
        .svc-card:focus-visible .card-line { width: 100%; }
